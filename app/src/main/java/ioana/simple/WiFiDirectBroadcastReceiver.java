...
public class WiFiDirectBroadcastReceiver extends BroadcastReceiver {
    ...
    private VerifyLocationActivity activity;

    public WiFiDirectBroadcastReceiver(WifiP2pManager manager, WifiP2pManager.Channel channel,
                                       VerifyLocationActivity activity) {
        super();
...
//                manager.requestConnectionInfo(channel, fragment);
                Log.d(TAG, "This device is connected to the other device");
            } else {
//                // It's a disconnect
//                activity.resetData();
                Log.d(TAG, "This device is disconnected from the other device");
            }
